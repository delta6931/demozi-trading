...
import { ChevronRight, ShieldCheck, Phone, Mail, FileText, CheckCircle2, Award, ExternalLink } from 'lucide-react';
    ...
    <div className="bg-white border border-[#CBD5E1] p-4 shadow-sm my-4 font-sans text-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-3 space-y-4">
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <div key={product.id} className="p-3 bg-white hover:bg-[#F8FAFC] flex flex-col justify-between">
                    <div>
                      <div className="w-full h-28 bg-[#F1F5F9] border border-[#E2E8F0] mb-2 p-2 flex items-center justify-center">
                        <img
                          src={product.image}
                          alt={product.name}
                          className="max-h-full max-w-full object-contain"
                    ...
                    <button
                      ...
                      className={`w-full py-1.5 text-[10px] font-bold uppercase font-mono border ${
                        isInQuote
          ...
          {/* 4. Recent Trade Transactions Ticker Table (Classic 2010 B2B feature) */}
          <div className="border border-[#CBD5E1] bg-white">
            ...
            <table className="b2b-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>2026-08-02</td>
                  <td>Industrial Hydraulic Pump Parts</td>
                  <td>Baghdad, Iraq</td>
